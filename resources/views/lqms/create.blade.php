...
<div class="content-wrapper"> 
      ...
      <!-- Breadcrumbs -->
        <ol class="breadcrumb">
          <li class="breadcrumb-item">
            <a href="lqms/create">LQMs Trainee</a>
          </li>
    ...
    {!! Form::open(array('route' => 'lqms.store','method'=>'POST')) !!}
      <div class="row">
      ...
      <div class="row">
          <div class="form-group col-md-1"><strong>Facility </strong></div>
          <div class="col-md-2"> {!! Form::text('facility', null, array('placeholder' => 'Facility Name', 'class' => 'form-control')); !!} </div>
      </div> 
