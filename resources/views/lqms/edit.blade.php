...
<div class="content-wrapper"> 
    ...
    {!! Form::model($lqmsTrainee, ['method'=>'POST', 'route' => ['lqms.edit',$lqmsTrainee->id]]) !!}
      {{csrf_field()}}
      <div class="row">
      ...
      <div class="row">
          <div class="form-group col-md-1"><strong>Facilityn </strong></div>
          <div class="col-md-2"> {!! Form::text('facility', null, array('class' => 'form-control')); !!} </div>
      </div> 
