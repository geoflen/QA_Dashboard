...
<html lang="en">
  ...
  <head>
    ...
    <link rel="shortcut icon" href="your_image_path_and_name.ico" /> <!-- TODDO GET IMAGE FOR THIS -TITLE ICON -->
  ...
  <body class="fixed-nav sticky-footer bg-dark" id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
      <a class="navbar-brand" href="#">UGANDA NATIONAL HEALTH LABORATORY SERVICES (UNHLS) QA Dashboard</a>
...
<!--           <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Example Pages">
          ...
          <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Auditors">
            <a class="nav-link" href="/auditor/index">
              <i class="fa fa-fw fa-balance-scale"></i>
              <span class="nav-link-text">
                Auditors</span>
            </a>
          </li>
          <li class="nav-item" data-toggle="tooltip" data-placement="right" title="LQMS-Trainees">
            <a class="nav-link" href="/lqms/index">
          ...
          <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Trainings">
            <a class="nav-link" href="/training/index">
              <i class="fa fa-fw fa-institution"></i>
              <span class="nav-link-text">
                Trainings</span>
            </a>
          </li>
          <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Trainers">
            <a class="nav-link" href="/trainer/index">
              <i class="fa fa-fw fa-male"></i>
              <span class="nav-link-text">
                Trainers</span>
            </a>
          </li>
          <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Facilities">
            <a class="nav-link" href="#">
